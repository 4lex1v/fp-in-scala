package fp.ch12_Applicatives

import fp.ch10_Monoids.{ Monoid, Foldable}
import fp.ch11_Monads.Functor
import fp.ch6_State._
import fp.ch6_State.State._
